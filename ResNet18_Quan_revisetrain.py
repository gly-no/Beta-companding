...
def run(M):
    ...
    # w_c1 = net.layer1[0].left[0].weight.data.reshape(1,-1)[0].numpy()
    # w_c2 = net.layer1[1].left[3].weight.data.reshape(1,-1)[0].numpy()
    # w_c3 = net.layer3[1].left[3].weight.data.reshape(1,-1)[0].numpy()
    ...
    # w_c19 = net.layer3[2].left[3].weight.data
    # out19 = W_Quan_betalaw_new(w_c19, M)
    # net.layer3[2].left[3].weight.data = out19[0]
    ...
    for epoch in range(epoch):
        ...
        #     # w_c19 = net.layer3[2].left[3].weight.data
        #     # out19 = W_Quan_betalaw_new(w_c19, M, out19[1],out19[2])
        #     # net.layer3[2].left[3].weight.data = out19[0]
